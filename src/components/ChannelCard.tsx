...
const getStyles = (theme: ThemePalette) =>
  StyleSheet.create({
    ...
    cardPlaying: {
      borderColor: '#FFFFFF',
      borderWidth: 3,
      backgroundColor: theme.mode === 'light' ? '#EEF2FF' : 'rgba(99, 102, 241, 0.25)',
    },
    cardFocused: {
      borderColor: '#FFFFFF',
      borderWidth: 3,
      backgroundColor: theme.mode === 'light' ? '#E0E7FF' : 'rgba(255, 255, 255, 0.18)',
      transform: [{ scale: 1.05 }],
      ...Platform.select({
        web: {
          boxShadow: '0px 0px 18px rgba(255, 255, 255, 0.9), 0px 4px 12px rgba(0, 0, 0, 0.6)',
        },
        default: {
          shadowColor: '#FFFFFF',
